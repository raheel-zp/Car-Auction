...
function ProductDetailedPageSold() {
    ...
    <div>
        ...
        <Helmet>
          <title> { Product?.metaTitle? 'Sold - ' + Product?.metaTitle : 'Sold - ' + Product?.title } </title>
          <meta
            name='description'
            content={ Product?.metaDescription? Product?.metaDescription : Product?.summary }
          />
          <link rel='canonical' href='/products-sold' />
          <meta
            name='keywords'
                ...
                <div className="bid-bar">
                  ...
                  <div className="bid-price">
                    <div className="single-bid-price">
                      <h3>£{ Product.sold? Product.sold.price:''}</h3>
                      <p>SOLD PRICE</p>
                    </div>
                    <div className="single-bid-time">
                      {/* <h3> {remDays>0?<>{remDays} days</>:<>{remainingTime}</>} </h3> */}
                      <h3> {Product.sold ? moment(Product.sold.date).fromNow():''} </h3>
                      <p> {Product.sold? new Date(Product.sold.date).toLocaleTimeString('en-US',{hour: 'numeric',minute: '2-digit',hour12: true,}):''} </p>
                    </div>
                    <div className="single-bid-time">
...
export default ProductDetailedPageSold;
