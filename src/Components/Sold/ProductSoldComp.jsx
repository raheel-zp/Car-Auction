  ...
  return (
    <>
        ...
        <div className="single-blog">
            <NavLink to={`/products-sold/${formattedTitle}`} >
              <div className="blog-img">
                <a ><img src={val.thumbnail} alt="" style={{borderRadius:'6px'}} /></a>
                <div className="blog-time">
                  <a className={remDays>0?'flex':''} style={{color:'black',fontSize: '13px',fontWeight: '600'}} >                
                      { val.sold ? moment(val.sold.date).fromNow():'' }
                      {/* { remDays>0?<>
                          {remDays} days
                      </>:<>
                          {remainingTime}
            ...
            <div className="blog-top-fl">
              <span style={{width:'90px'}} >Sold</span>
...
export default ProductSoldComp
