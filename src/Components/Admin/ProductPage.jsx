...
function ProductPage({fetchAllProducts,products,setProducts}) {
    const {userlogged,setuserLogged,userData,setuserData,url} = useContext(userloggedIn);
    const filteredProducts = products.filter(product => product.category !== 'expired');
    ...
    const [bulletPoints, setBulletPoints] = useState([{ text: '', split: false }]);
    ...
    const [bulletPoints2, setBulletPoints2] = useState([{ text: '', split: false }]);
    ...
    // For Condition  
    const [bulletPoints3, setBulletPoints3] = useState([{ text: '', split: false }]);
    ...
    // For Service History
    const [bulletPoints4, setBulletPoints4] = useState([{ text: '', split: false }]);
