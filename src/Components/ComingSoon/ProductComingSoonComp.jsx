...
function ProductComingSoonComp({val}) {
  ...
  return (
    <>
        ...
        <div className="single-blog">
            <NavLink to={`/products-comingsoon/${formattedTitle}`} target="_blank" >
            ...
            <div className="blog-top-fl">
              <span style={{width:'90px'}} >Coming Soon</span>
...
export default ProductComingSoonComp
