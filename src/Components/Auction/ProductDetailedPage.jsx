...
function ProductDetailedPage() {
    ...
    const placeBid = async ()=>{
      ...
      console.log(new Date(Product.endTime).getTime());
      if(!userlogged){
    ...
    <div>
      ...
      <Helmet>
        <title> { Product?.metaTitle? 'Auction - ' + Product?.metaTitle : 'Auction - ' + Product?.title } </title>
        <meta
          name='description'
                ...
                <div className="bid-bar">
                  ...
                  <div className="bid-price">
                    <div className="single-bid-price">
                      <h3>£{ Product.bids && Product.bids.length>0 ? Product.bids[0].price : 0}</h3>
                      <p>CURRENT BID</p>
                    </div>
                        ...
                        <div className="car-info-post-box" id="scroll-comment">
                          ...
                          <div className="car-info-post-last">
                            <div className="car-info-post-last-title">
                              <h3 onClick={cons} >PREVIOUS QUESTIONS</h3>
                            </div>
