...
function ProductBuyNowComp({val}) {
  ...
  return (
    <>
        ...
        <div className="single-blog">
            <NavLink to={`/products-buynow/${formattedTitle}`} target="_blank" >
              <div className="blog-img">
                ...
                <div className="blog-time">
                  ...
                  {   
                    val.category==='auction'? <>£{val.startPrice}</>:
            ...
            <div className="blog-top-fl">
              <span style={{width:'75px'}} >{val.offers.length} Offers</span>
...
export default ProductBuyNowComp
